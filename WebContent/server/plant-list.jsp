...
<html class="x-admin-sm">
  ...
  <body>
    ...
    <div class="x-body">
      <div class="layui-row">
        <form class="layui-form layui-col-md12 x-so" action="${pageContext.request.contextPath}/plant?op=scach"
         method="post">
          <input type="text" name="plateTitle"  placeholder="请输入模块名" autocomplete="off" class="layui-input">
      ...
      <table class="layui-table x-admin">
        ...
        <c:forEach items="${plant }" var="p">
          <tr>
            ...
            <td>
            	<c:if test="${p.isEnable==0 }" var="i">未被屏蔽</c:if>
            	<c:if test="${!i}">已被屏蔽</c:if>
            </td>
            <td class="td-status">
            ...
            <td class="td-manage">
              ...
              <a title="修改"  onclick="x_admin_show('修改','plant?op=findeByid&plateId=${p.plateId }')" href="javascript:;">
                <i class="layui-icon">&#xe642;</i>
              </a>
              <a title="删除" onclick="member_del(this,'${p.plateId }')" href="javascript:;">
                <i class="layui-icon">&#xe640;</i>
              </a>
            </td>
          </tr>
    ...
    <script>
    	$(function() {
			$.post("${pageContext.request.contextPath}/plant?op=showAll");
		});
