        ...
        <tbody>
        	<c:set var="i" value="0"></c:set>
         	<c:forEach items="${user }" var="u">
		            ...
		            <td><c:if test="true">${i=i+1 }</c:if></td>
		            <td> ${u.userId } </td>
		            <td> ${u.userPsw }</td>
		            <td> ${u.userSex }</td>
		            <td> ${u.userEmail } </td>
		            <td> ${u.userCreateDate } </td>
		            <td class="td-status">
		            ...
		            <td class="td-manage">
		              ...
		              <a title="编辑"  onclick="x_admin_show('编辑','UserServlet?op=showID&id=${u.userId }',600,400)" href="javascript:;">
		                <i class="layui-icon">&#xe642;</i><!-- ${pageContext.request.contextPath}/server/member-edit.jsp -->
		              </a>
		              <a onclick="x_admin_show('修改密码','${pageContext.request.contextPath}/server/member-password.jsp',600,400)" title="修改密码" href="javascript:;">
		                <i class="layui-icon">&#xe631;</i><!-- ${pageContext.request.contextPath}/server/member-password.jsp -->
		              </a>
    ...
    <script>
      ...
      function member_del(obj,id){
          layer.confirm('确认要删除吗？',function(index){
        	 $.post("${pageContext.request.contextPath }/UserServlet?op=delete",{userId:id},function(data){
        		 if(data.result=="true"){
        			//发异步删除数据
